...
public class RainChildBullet : MonoBehaviour
{
    ...
    private RainParentBullet parent;
    private Transform transformCache;

    void Start()
    {
        transformCache = GetComponent<Transform>();
        parent = gameObject.GetComponentInParent<RainParentBullet>();
    }
    ...
    public void SetVariable(Vector2 direction, float bulletSpeed)
    {
        Direction = direction; 
