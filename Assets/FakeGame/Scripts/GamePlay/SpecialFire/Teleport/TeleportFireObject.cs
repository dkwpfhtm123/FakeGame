...
{
    public class TeleportFireObject : MonoBehaviour
    {
        private TeleportFireObject instance;
        public TeleportFireObject Instance
        {
            get
            {
                if (instance == null)
                    instance = FindObjectOfType<TeleportFireObject>();
        ...
        IEnumerator CreateBullet()
        {
            ...
            while (true)
            {
                for (int i = 0; i < 12; i++)
                {
                    ...
                    TeleportBullet bullet = bulletObject.GetComponent<TeleportBullet>();
